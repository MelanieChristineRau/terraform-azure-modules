...
Workspace based App Insights with sampling.

Portal equivalent: Create Application Insights, workspace based

Use it when: Web apps, Functions, hackathon RAG mode.
