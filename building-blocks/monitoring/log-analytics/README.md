...
Central logs. 30 day retention is fine for sandbox.

Portal equivalent: Create Log Analytics workspace

Use it when: Every pattern that should not leave monitoring until after go-live.
