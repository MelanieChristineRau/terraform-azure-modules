...
Linux or Windows web app with identity, HTTPS only and App Insights wiring.

Portal equivalent: Create Web App, identity, HTTPS, logs, slots

Use it when: A website or Drupal front end.
