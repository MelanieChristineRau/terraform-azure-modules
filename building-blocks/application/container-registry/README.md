...
ACR with admin disabled. Name has hyphens stripped.

Portal equivalent: Create container registry, disable admin user

Use it when: Anything that pushes images.
