...
The plan that web apps, Functions and Logic Apps Standard sit on.

Portal equivalent: Create App Service plan, pick OS and SKU

Use it when: Before a web-app, function-app or logic-app-standard block.
