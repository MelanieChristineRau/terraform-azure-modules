...
RBAC vault. No secrets in examples. Purge protection off in sandbox.

Portal equivalent: Create Key Vault, RBAC, networking

Use it when: Passwords and connection strings for apps.
