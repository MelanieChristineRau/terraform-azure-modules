...
Private connection to PaaS. Pair with private DNS.

Portal equivalent: Resource > Networking > Private endpoint

Use it when: Key Vault, storage, web apps, AI in a locked-down VNet.
